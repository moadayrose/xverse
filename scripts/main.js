...
function convertCSVArrayToTraineeData(csvArrays) {
  trainees = csvArrays.map(function(traineeArray, index) {
    ...
    trainee.eliminated = traineeArray[1] === 'e'; // sets trainee to be eliminated if 'e' appears in 6th col
    trainee.top6 = traineeArray[1] === 't'; // sets trainee to top 6 if 't' appears in 6th column
    trainee.selected = false;
    trainee.id = parseInt(traineeArray[2]) - 1; // trainee id is the original ordering of the trainees in the first csv
    trainee.image =
  ...
  <div class="ranking__entry ${eliminated}">
    <div class="ranking__entry-view">
      <div class="ranking__entry-icon">
        ...
        <div class="ranking__entry-icon-border a-rank-border" data-rankid="${currRank-1}"></div>
      </div>
...
const currentURL = "https://moadayrose.github.io/xverse/";
